...
FILE_OPERATIONS=$(FILE_OPERATIONS_PATH)PieceFileData.o $(FILE_OPERATIONS_PATH)WritingAutomata.o $(FILE_OPERATIONS_PATH)ReadingAutomata.o $(FILE_OPERATIONS_PATH)FileOperations.o
